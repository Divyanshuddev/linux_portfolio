...
import AllAppsPanel from "./AllAppsPanel"
const DEFAULT_SIZE = { width: "96vw", height: "97vh" }
...
const AllAppsWindow = ({ id, zIndex, bringToFront, defaultPosition }: AllAppsWindowProps) => {
    ...
    return (
        ...
        >
            <Stack
                ...
                <AllAppsPanel toggleResize={toggleResize} />
            </Stack>
        </Stack>
    )
}
export default AllAppsWindow