...
const ImageViewerWindow = ({ id, zIndex, bringToFront, defaultPosition }: ImageViewerWindowProps) => {
    const minimizeWindow = useSelector((state: RootState) => state.window.minimizeImageWindow)
